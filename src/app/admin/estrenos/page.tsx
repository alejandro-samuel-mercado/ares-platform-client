...
const PLATFORM_COLORS: Record<string, string> = {
  ...
  AMAZON: '#FF9900', APPLE: '#000000', PARAMOUNT: '#0065CC',
...
export default function EstRenosAdminPage() {
  ...
  const fetch = async () => {
    setLoading(true);
    try { setEstrenos(await api.get('/admin/estrenos')); } finally { setLoading(false); }
  };
    ...
    <div style={{ maxWidth: 1200, margin: '0 auto' }}>
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '3rem' }}>
        <div>
          ...
          <p style={{ fontWeight: 700, opacity: 0.5 }}>Novedades que los vendedores ven en su app.</p>
        </div>
