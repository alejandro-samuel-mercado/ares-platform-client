  ...
  return (
    <div style={{ maxWidth: '1400px', margin: '0 auto' }}>
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '3.5rem' }}>
        <div>
          <h1 style={{ fontSize: '2.8rem', fontWeight: 900, display: 'flex', alignItems: 'center', gap: '1rem' }}>
            PARTIDOS <span className="text-gradient-primary">MAESTROS</span>
            <button 
      ...
      <div style={{ display: 'flex', gap: '1.5rem', marginBottom: '3rem' }}>
        ...
        <div className="card-static" style={{ display: 'flex', alignItems: 'center', gap: '1rem', padding: '0 2rem', background: 'var(--surface-raised)' }}>
