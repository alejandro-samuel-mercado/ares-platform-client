...
export default function LandingPage() {
  return (
    <div className="landing-layout" style={{ background: 'var(--surface-base)', minHeight: '100vh', color: 'var(--text-primary)', overflowX: 'hidden' }}>
      ...
      <nav className="glass-nav" style={{ position: 'fixed', top: 0, left: 0, right: 0, zIndex: 50, padding: '1rem 2rem' }}>
        <div style={{ maxWidth: '1200px', margin: '0 auto', display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
          ...
          <div style={{ display: 'flex', gap: '1.5rem', alignItems: 'center' }}>
            ...
            <Link href="/register" className="btn-primary" style={{ padding: '0.75rem 1.5rem', borderRadius: '12px', fontSize: '0.9rem' }}>
              Ser Vendedor
            </Link>
          </div>
        </div>
      ...
      {/* Hero Section */}
      <section style={{ position: 'relative', zIndex: 10, paddingTop: '12rem', paddingBottom: '6rem', paddingLeft: '2rem', paddingRight: '2rem', textAlign: 'center' }}>
        <div style={{ maxWidth: '900px', margin: '0 auto', padding: '0 1.5rem' }}>
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }}>
            ...
            <div style={{ display: 'flex', gap: '1.5rem', justifyContent: 'center', flexWrap: 'wrap' }}>
              <Link href="#comprar" className="btn-primary" style={{ padding: '1.2rem 2.5rem', borderRadius: '16px', fontSize: '1.1rem', display: 'flex', alignItems: 'center', gap: '0.75rem' }}>
                <MonitorPlay size={24} /> Comprar Cuenta
              </Link>
              <Link href="#vender" className="btn-secondary" style={{ padding: '1.2rem 2.5rem', borderRadius: '16px', fontSize: '1.1rem', display: 'flex', alignItems: 'center', gap: '0.75rem', background: 'rgba(255,255,255,0.05)', border: '1px solid rgba(255,255,255,0.1)' }}>
                <TrendingUp size={24} /> Quiero Revender
              </Link>
            </div>
          </motion.div>
        </div>
      ...
      <section id="comprar" style={{ padding: '6rem 2rem', background: 'rgba(0,0,0,0.3)', borderTop: '1px solid rgba(255,255,255,0.02)' }}>
        <div style={{ maxWidth: '1200px', margin: '0 auto' }}>
          <div style={{ textAlign: 'center', marginBottom: '4rem' }}>
            <h2 style={{ fontSize: '3rem', fontWeight: 900, marginBottom: '1rem' }}>EL MEJOR CATÁLOGO</h2>
      ...
      {/* For Vendors Section */}
      <section id="vender" style={{ padding: '8rem 2rem', position: 'relative' }}>
        <div style={{ maxWidth: '1200px', margin: '0 auto', display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '4rem', alignItems: 'center' }}>
          
          <motion.div initial={{ opacity: 0, x: -30 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }}>
            <h2 style={{ fontSize: '3.5rem', fontWeight: 900, lineHeight: 1.1, marginBottom: '1.5rem' }}>
      ...
      {/* Footer */}
      <footer style={{ borderTop: '1px solid rgba(255,255,255,0.05)', padding: '4rem 2rem', textAlign: 'center', background: 'rgba(0,0,0,0.5)' }}>
